...
<div class ="container text-center" >
    ...
    <div class ="container">
        <form action="profile" method="post">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="userId" placeholder="아이디" readonly value= "<?= set_value('userId',$user['userId']) ?>">
            </div>
            </div>
            <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="name" id="inputPassword" placeholder="이름"  value= "<?= set_value('name',$user['name']) ?>">
            </div>
            </div>
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-2 col-form-label">이메일</label>
            <div class="col-sm-10">
                <input type="email" class="form-control" id="email" name="email" placeholder="이메일" readonly value="<?= set_value('email',$user['email']) ?>">
            </div>
            </div>
